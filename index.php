                        ...
                        <div class="menu-wrapper d-flex align-items-center justify-content-between">
                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a href="#">Home</a></li>
                                        <li><a href="tampilan/login.html">Order</a></li>
                                        <li><a href="tampilan/login.html">Status</a></li>
                                ...
                                <div class="mobile_menu d-block d-lg-none">
                                    <div class="slicknav_menu">
                                        ...
                                        <ul class="slicknav_nav slicknav_hidden" style="display: none;"
                                            ...
                                            <li><a href="tampilan/login.html" role="menuitem" tabindex="-1">Order</a>
                                            </li>
                                            <li><a href="tampilan/login.html" role="menuitem" tabindex="-1">Status</a>
                                            </li>
                                            <!-- <li><a href="review.html" role="menuitem" tabindex="-1">Review</a></li> -->
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-9 col-lg-9 col-md-10">
                                <div class="hero__caption">
                                    ...
                                    <a href="tampilan/login.html" class="border-btn hero-btn"
                                        data-animation="fadeInLeft" data-delay="0.8s">Go Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="form">
            <div class="result-wrapper">
                <a href="Controller/logout.php"><button type="button" class="btn btn-primary jarakk">Log
                        Out</button></a>
                <a href="Controller/edit.php"><button type="button" class="btn btn-primary jarakk">Edit</button></a>
            </div>
        </div>
    </div>
    <script>
