                                ...
                                <div class="mobile_menu d-block d-lg-none">
                                    <div class="slicknav_menu">
                                        ...
                                        <ul class="slicknav_nav slicknav_hidden" style="display: none;"
                                            ...
                                            <li><a href="order.php" role="menuitem" tabindex="-1">Order</a></li>
                                            <li><a href="status.php" role="menuitem" tabindex="-1">Status</a></li>
                                            <li><a href="historyBooster.php" role="menuitem" tabindex="-1">History</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
