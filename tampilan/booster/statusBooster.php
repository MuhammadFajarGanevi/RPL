...
$role = $_SESSION['role'];
$id_booster = $_SESSION['id_account'];

// Mempersiapkan statement
$stmt = $conn->prepare("SELECT * FROM orders WHERE id_booster = ?");
// Mengikat parameter
$stmt->bind_param("s", $id_booster);
                    ...
                    if ($status == "process" || $status == "success") {
                        ...
                        <div class="form-wrapper-input">
                            ...
                            <form class="formulir" action="order.php" method="post" onsubmit="return validateForm()">
                                <div class="grup-kiri-kanan">
                                    <div class="grup-kiri">
                                        ...
                                        <div class="form-group">
                                            <label>ID Game</label>
                                            <input class="form-output" value="<?php echo $idgame; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <!-- Rank Awal -->
                                    ...
                                    <div class="grup-kanan">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-output" value="<?php echo $passgame; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            <!-- Rank Akhir -->
                            ...
                            <?php if ($status == "process") { ?>
                                <a href="terima2.php?id_order=<?php echo $id_order; ?>"> <button
